<?php
// es el view para enviar por mail los avisos
//debug($client);
?>
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="0" class="container">
                        <tr>
                            <td class="container-padding header" align="left">
                                ...
                                ?>
                                <img alt="logo" style="width:70px" src="<?= $logo ?>"><br>
                        ...
                        <tr>
                            <td class="container-padding content" align="left">
                                <br>
                                <div class="title">
                                    <?= h("Estimado Propietario:") ?>
                                </div>
                                <br>
                                <div class="body-text">
                                    <?= strip_tags($client['cuerpoemailaviso']) ?>
                                </div>
                                <br>
                                <div class="title2Xbc">
                                    <?php
                                    echo "<a target='_blank' rel='nofollow noopener noreferrer' href='https://$url" . "avisos/view/$link'>Visualizar Expensas</a>";
                                    ?>
                                </div>
                                <br>
                        ...
                        <tr style="text-align:center">
                            <td>
                                ...
                                if (!empty($codigo)) {
                                    ?>
                                    <hr>
                                    <a href='https://play.google.com/store/apps/details?id=ar.com.ceonline.expensasceo'>
                                        <img alt='EXPENSAS CEO' style="width:70px" src='https://ceonline.com.ar/web/app.png'/>
                                    </a>
                                    <br>
                                    Visualiz&aacute; tus Expensas en tu celular con nuestra App (disponible solo para Android) &nbsp; 
                                    <br>
