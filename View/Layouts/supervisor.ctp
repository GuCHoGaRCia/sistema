...
<html lang="es-419">
    <head>
        ...
        <?php
        echo $this->Minify->css(['admin.css', 'menustyle', 'jquery-ui.min', 'select2.min'], ['fullBase' => true, 'pathPrefix' => 'https://ceonline.com.ar']);
        ...
        echo $this->Minify->script(['jq', 'bs', 'jqui', 'jqval', 'jqvales', 'am', 'jqmeta', 'm', 'bsedit', 'adm', 's2', 'i18n/es', 'datepicker-es'], ['fullBase' => true, 'pathPrefix' => 'https://ceonline.com.ar']);
        ?>
