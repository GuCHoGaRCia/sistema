...
<html lang="es-419">
    <head>
        <title>Anal&iacute;tico de Cobranzas</title>
        <?php
    ...
    <body style='text-align:center'>
        ...
        function detalle($movimientos, $rubrosinfo, $liquidationinfo, $cobranzas, $grafico = false) {
            ...
            <div style='width:80%;max-width:80%'>
                <canvas id="myChart" height='250' style="display:block;height:300px;width:80% !important"></canvas>
            </div>
            <br><br><br><br>
            <script>
        ...
        ?>
                        ...
                        datasets: [
                            {label: "Detalle de Gastos anuales por Rubro",
                                ...
                                backgroundColor: ["rgba(255, 99, 132, 0.2)", "rgba(255, 159, 64, 0.2)", 'rgba(255, 99, 132, 0.2)', "rgba(255, 205, 86, 0.2)", "rgba(75, 192, 192, 0.2)", "rgba(54, 162, 235, 0.2)", "rgba(153, 102, 255, 0.2)", "rgba(201, 203, 207, 0.2)", "rgba(255, 99, 132, 0.2)", "rgba(255, 159, 64, 0.2)", "rgba(255, 205, 86, 0.2)", "rgba(75, 192, 192, 0.2)", "rgba(54, 162, 235, 0.2)", "rgba(153, 102, 255, 0.2)", "rgba(201, 203, 207, 0.2)", 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(153, 102, 255, 0.2)', 'rgba(255, 159, 64, 0.2)'],
