<div class="cartas index">
    ...
    echo "<div style='position:absolute;top:110px;right:150px'>" . $this->element('toolbar', ['pagecount' => false, 'pagesearch' => false, 'pagenew' => false, 'print' => false, 'multidelete' => false, 'model' => 'Carta']) . "</div>";
    echo "</div>";
    ?>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th><?php echo $this->Paginator->sort('created', __('Fecha Carga')); ?></th>
        ...
        <tbody>
            ...
            foreach ($cartas as $carta):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><?php echo $this->Time->format(__('d/m/Y'), $carta['Carta']['created']) ?>&nbsp;</td>
...
<script>
    $(document).ready(function () {
        ...
        $("#CartaConsorcio").select2({language: "es", allowClear: true, placeholder: '<?= __('Consorcio...') ?>', width: 275});
    });
</script>
