...
<html lang="es-419">
    <head>
        <title>Composici&oacute;n de saldos Particulares - <?= h($consorcio['Consorcio']['name'] . " - " . $info['Liquidation']['periodo']) ?></title>
    ...
    <body>
        ...
        detalle($data, $cuentasinfotemp, $data['gastosinfo'], $consorcio['interes'], $esinicial);
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <p style="border-top:2px solid #9baff1;text-align:center;line-height:7px;"><br>
                            ...
                            <br><br>SA: saldo anterior, RA: Redondeo Anterior, COB: Cobranzas, AJ: Ajustes, SR: saldo remanente, <br><br>GP: gastos particulares, 
                            IA: inter&eacute;s actual, R: redondeo, Saldo Final: +RA + SR + [Columnas Gastos] + IA - R
                        </p>
                    </td>
                </tr>
            </table>
        ...
        function detalle($data, $cuentasinfo, $gastosinfo, $consorciointeres, $esinicial) {
