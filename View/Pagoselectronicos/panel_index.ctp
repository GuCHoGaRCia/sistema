<div class="pagoselectronicos index">
    <h2><?php echo __('Pagos PLAPSA'); ?></h2>
    <?php
    echo $this->element('toolbar', ['filter' => ['enabled' => true, 'options' => $clients, 'field' => 'client', 'panel' => true], 'pagesearch' => true, 'multidelete' => true, 'pagenew' => true, 'model' => 'Pagoselectronico']);
    ?>
