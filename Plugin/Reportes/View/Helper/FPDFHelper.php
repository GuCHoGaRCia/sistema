...
class PDF_i25{
	public function PDF_i25($orientation='P', $unit='mm', $size='A4'){
	// Some checks
	$this->_dochecks();
	...
	$this->CoreFonts=array('courier'=>'Courier', 'courierB'=>'Courier-Bold', 'courierI'=>'Courier-Oblique', 'courierBI'=>'Courier-BoldOblique',
		'helvetica'=>'Helvetica', 'tahoma'=>'Tahoma', 'tahomaB'=>'Tahoma-Bold', 'helveticaB'=>'Helvetica-Bold', 'helveticaI'=>'Helvetica-Oblique', 'helveticaBI'=>'Helvetica-BoldOblique',
...
function SetFont($family, $style='', $size=0)
{
	...
	if(!isset($this->fonts[$fontkey]))
	{
		...
		$this->CoreFonts=array('courier'=>'Courier', 'courierB'=>'Courier-Bold', 'courierI'=>'Courier-Oblique', 'courierBI'=>'Courier-BoldOblique',
			...
			'times'=>'Times-Roman', 'timesB'=>'Times-Bold', 'timesI'=>'Times-Italic', 'timesBI'=>'Times-BoldItalic',
			'symbol'=>'Symbol', 'zapfdingbats'=>'ZapfDingbats');
		//debug(in_array($family,array_keys($this->CoreFonts)));die;
		if(in_array($family,array_keys($this->CoreFonts)))
		{
			...
			$this->Error('Undefined1 font: '.$family.' '.$style);
	}
	// Select it
