...
<html lang="es-419">
    <head>
        ...
        <?php
        echo $this->Minify->css(array('admin.css', 'menustyle', 'jquery-ui.min', 'select2.min'));
        echo $this->Minify->css(array('main', 'bootstrap.min.css', 'bootstrap-editable.css'));
        echo $this->Html->meta('icon');
        echo $this->Html->charset();
        echo $this->Minify->script(['jq', 'bs', 'jqui', 'jqval', 'jqvales', 'am', 'jqmeta'/* . $this->Session->read('Config.language') */, 'm', 'bsedit', 'admpanelclientes', 's2', 'i18n/es']);
        ?>
                    ...
                    <span class="tooltipx"><?php echo $this->Html->image('help.png', array('width' => '24px', 'height' => '24px', 'id' => 'helpimg')); ?>
                        <span id="helpcontent"><?php echo $help["Help"]["content"]; ?>
                            ...
                            if ($_SESSION['Auth']['User']['is_admin']) {
                                echo $this->Html->image('edit.png', array('width' => '16px', 'height' => '16px', 'alt' => __('Editar'), 'title' => __('Editar'), 'url' => array('controller' => 'panel/Helps', 'action' => 'edit', $help["Help"]['id'])));
                            }
                            ?>
                        </span>                    
                    </span>
