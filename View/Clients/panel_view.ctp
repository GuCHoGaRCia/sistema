        ...
        <tbody>
            ...
            foreach ($client['User'] as $user):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><span class="username" data-value="<?php echo h($user['username']) ?>" data-pk="<?php echo h($user['id']) ?>"><?php echo h($user['username']) ?></span>&nbsp;</td>
                    ...
                    <td class="acciones">
                        ...
                        echo $this->Form->postLink($this->Html->image('delete.png', array('alt' => __('Eliminar'), 'title' => __('Eliminar'))), array('controller' => 'Users', 'action' => 'delete', $user['id']), array('escapeTitle' => false), __('Eliminar el dato # %s?', $user['id']));
                        ?>
                    </td>
                    <td class="borde_tabla"></td>
                </tr>
