                ...
                <table border="0" valign="top" cellspacing="0" width="720" <?= $formato ?>>
                    <tr>
                        <td align="center" style="border:0px;">
                            <span style="width:60px;float:left;margin:20px 0px 0px -100px"></span>
                            <font style="font-size:14px;font-weight:700;"><?= h($propietario['name'] . " (" . $propietario['code'] . ") " . $propietario['unidad']) ?></font><BR>
                            <?= h($propietario['postal_address']) ?><br>
                            <?= h($propietario['postal_city']) ?><br>
                        </td>
                        <td class="right" style="border:0px;"><h2>IMPORTE ABONADO: 
                                <?php
