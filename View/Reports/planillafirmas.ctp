...
<html lang="es-419">
    <head>
        <title>Planilla de Firmas - <?= h($consorcio['name']) ?></title>
...
function detalle($data) {
    ...
    <table valign=top cellspacing=0 <?= $formato ?> class="box-table-b" align="center">
        <thead>
            <tr><td colspan="4" style='text-align:center;font-weight:bold'>PLANILLA DE FIRMAS</td></tr>
            <tr>
                <th class="totales" style="width:300px;text-align:left"><b>Propietario - Unidad - C&oacute;digo(<?= count($data) ?>)</b></th>
                <th class="totales right" style="width:150px"><b>Firma</b></th>
                <th class="totales right" style="width:150px"><b>Aclaraci&oacute;n</b></th>
                <th class="totales right" style="width:150px"><b>Caracter</b></th>
            </tr>
        </thead>
        <?php
        foreach ($data as $p) {
