...
<div class="users form">
    ...
    <fieldset>
        ...
        echo $this->JqueryValidation->input('username', array('label' => __('Usuario') . ' * '/* (recordar ingresar al sistema con usuario@' . $_SESSION['Auth']['User']['Client']['identificador_cliente'] . ')' */));
        echo $this->JqueryValidation->input('password', array('label' => __('Contraseña') . ' *', 'id' => 'password', 'data-display' => 'dpassword'));
