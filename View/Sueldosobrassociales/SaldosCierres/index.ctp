        ...
        <tbody>
            ...
            foreach ($saldosCierres as $saldosCierre):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><?php echo h($saldosCierre['Consorcio']['name'] . " - " . $saldosCierre['Liquidation']['name']); ?></td>
            ...
            <td><?php echo h($saldosCierre['SaldosCierre']['interes']) ?>&nbsp;</td>
            <td><?php echo h($saldosCierre['SaldosCierre']['redondeo']) ?>&nbsp;</td>
