            ...
            <table valign=top cellspacing=0 <?= $formato ?> class="box-table-b" align="center" id="floatth">
                ...
                foreach ($data['prop'] as $p) {
                    ...
                    foreach ($data['descripcioncoeficientes'] as $k => $v) { // los %
                        $totalporcentajes[$k] += $data['totales'][$p['id']]['coefgen'][$k]['val'];
                        echo "<td style='text-align:right;width:auto'>" . $data['totales'][$p['id']]['coefgen'][$k]['val'] . "</td>";
                    }
                ...
                // muestro los totales
                echo "<tr style='font-weight:bold'><td style='width:120px;text-align:center'>TOTALES</td>";
                foreach ($data['descripcioncoeficientes'] as $k => $v) { // los %
